...
const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  const [textStep, setTextStep] = useState(0); // 0: 당신만을 위한, 1: 소담, 2: 소상공인을 담다
  ...
  return (
    ...
    >
      {/* 배경 원형 확장 애니메이션 */}
      <div className={`${styles.backgroundCircle} ${expandBackground ? styles.expand : ''}`} />
      ...
      <div className={styles.container}>
        {textStep === 0 && (
          ...
          <div className={styles.titleWrapper}>
            <h1 className={`${styles.title} ${styles.subtitle} ${showText ? styles.show : ''}`}>
              당신만을 위한
            </h1>
          </div>
        )}
