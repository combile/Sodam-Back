...
const SignupCompleteStep = () => {
  ...
  return (
    <div className={commonStyles.signupCompleteWrapper}>
      <div className={`${commonStyles.loginDeco} ${commonStyles.circle1} ${completeStyles.celebrationFloat}`} />
      <div className={`${commonStyles.loginDeco} ${commonStyles.circle2} ${completeStyles.celebrationFloat}`} />
          ...
          {[...Array(20)].map((_, i) => (
            <div
              ...
              style={{
                ...
                backgroundColor: ['#7DDB69', '#579DB7', '#5FC24A', '#F4FFF1'][Math.floor(Math.random() * 4)]
              }}
            />
          ))}
        </div>
      ...
      <div className={completeStyles.completeContainer}>
        ...
        <h2 className={completeStyles.completeTitle}>
          회원가입이 <br />
          <span className={completeStyles.completeHighlight}>완료되었습니다!</span>
        </h2>
        ...
        <div className={completeStyles.welcomeMessage}>
          <p className={completeStyles.welcomeText}>
            소상공인을 위한 든든한 동반자 <strong>소담</strong>에 오신 것을 환영합니다!
          </p>
        ...
        <div className={completeStyles.actionButtons}>
          <Link to="/dashboard" className={completeStyles.primaryButton}>
            서비스 시작하기
          </Link>
          <Link to="/profile" className={completeStyles.secondaryButton}>
            프로필 수정하기
          </Link>
        </div>
        ...
        <div className={completeStyles.additionalInfo}>
          <p className={completeStyles.infoText}>
            궁금한 점이 있으시면 <a href="/help" className={completeStyles.helpLink}>도움말</a>을 확인해보세요
          </p>
        </div>
      </div>
    </div>
