...
def create_app(config_object: type = Config) -> Flask:
    ...
    cors.init_app(app, resources={
        r"/*": {
            "origins": [
                ...
                "https://combile.github.io/sodam",  # Specific path
                "https://combile.github.io/sodam/",  # With trailing slash
                "https://combile.github.io/sodam/*"  # All subpaths
            ],
    ...
    def after_request(response):
        ...
        elif origin and origin.startswith("https://combile.github.io"):
            response.headers['Access-Control-Allow-Origin'] = origin
        
        response.headers['Access-Control-Allow-Methods'] = 'GET, POST, PUT, DELETE, OPTIONS, PATCH, HEAD'
        response.headers['Access-Control-Allow-Headers'] = 'Content-Type, Authorization, X-Requested-With, Accept, Origin, Access-Control-Request-Method, Access-Control-Request-Headers, X-CSRFToken, Cache-Control, Pragma'
