  ...
  return (
    <main className={styles.container}>
      ...
      <section className={styles.featureCards} style={cardsStyle}>
        ...
        <div className={styles.cardWrapper}>
          <div className={`${styles.card} ${styles.cardLightGreen}`}>
            <h3 className={styles.cardTitle}>
              내일은
              <br />
              사장
      ...
      <section className={styles.marketSection}>
        ...
        <div className={styles.marketCards}>
          <div className={styles.marketCard}>
            <h4>평균 매출액</h4>
            <p className={styles.marketPeriod}>2025년 1월 기준</p>
            <div className={styles.marketStats}>
              <div className={styles.statItem}>
                <span className={styles.statLabel}>전년</span>
                <span className={styles.statValue}>93,770만</span>
              </div>
              <div className={styles.statItem}>
                <span className={styles.statLabel}>작년</span>
                <span className={styles.statValue}>89,182만</span>
              </div>
            </div>
          ...
          <div className={styles.marketCard}>
            ...
            <div className={styles.populationChart}>
              <div className={styles.barGroup}>
                ...
                <span className={styles.barLabel}>호수상가</span>
              </div>
              <div className={styles.barGroup}>
                <div className={styles.bar} style={{ height: "40%" }}></div>
                <span className={styles.barLabel}>대학로</span>
              </div>
              <div className={styles.barGroup}>
                <div className={styles.bar} style={{ height: "85%" }}></div>
                <span className={styles.barLabel}>중구청</span>
              </div>
              <div className={styles.barGroup}>
                <div className={styles.bar} style={{ height: "70%" }}></div>
                <span className={styles.barLabel}>문화동</span>
              </div>
              <div className={styles.barGroup}>
                <div className={styles.bar} style={{ height: "55%" }}></div>
                <span className={styles.barLabel}>기타</span>
              </div>
            </div>
          </div>
          ...
          <div className={styles.marketCard}>
            ...
            <div className={styles.businessCount}>
              <span className={styles.countNumber}>69,181</span>
